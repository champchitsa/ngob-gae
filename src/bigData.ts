...
export const signalLawMap: Record<SignalKey, string[]> = {
  new_after_act: ['พ.ร.บ. วิธีการงบประมาณ พ.ศ. 2561 ม.46', 'พ.ร.บ. วินัยการเงินการคลังของรัฐ พ.ศ. 2561 ม.6'],
  transfer_up: ['พ.ร.บ. วิธีการงบประมาณ พ.ศ. 2561 ม.46', 'พ.ร.บ. วินัยการเงินการคลังของรัฐ พ.ศ. 2561 ม.6'],
  transfer_down: ['พ.ร.บ. วิธีการงบประมาณ พ.ศ. 2561 ม.46', 'พ.ร.บ. วินัยการเงินการคลังของรัฐ พ.ศ. 2561 ม.6'],
...
export const investigationPath = [
  ...
  { step: '02', title: 'โอนเปลี่ยน', question: 'เงินย้ายจากไหน เพราะอะไร และเป้าหมายเปลี่ยนหรือไม่', evidence: 'คำสั่งโอน รายการต้นทางและปลายทาง เหตุผล และผู้อนุมัติ', law: 'วิธีการงบประมาณ ม.46' },
...
export const legalActionMap = [
  {
    ...
    trigger: 'ใช้เมื่อพบราคาต่อหน่วยผิดช่วง คู่แข่งน้อย ชื่อรายการกว้าง หรือส่งมอบไม่สัมพันธ์กับยอดจ่าย',
  ...
  },
  {
    ...
    title: 'ประสิทธิภาพ ความคุ้มค่า โปร่งใส และตรวจสอบได้',
    trigger: 'ใช้เมื่อวงเงินสูง ผลลัพธ์ไม่ชัด ค่าใช้จ่ายซ้ำ หรือผลประโยชน์ต่อประชาชนยังตอบไม่ได้',
  ...
  },
  {
    ...
    trigger: 'ใช้เมื่อมีการโอนเพิ่ม ลดวงเงิน เบิกจ่ายช้า ไม่มีค่าระดับรายการ หรือยอดต้องกระทบยอดใหม่',
  ...
  },
  {
    ...
    trigger: 'ใช้เมื่อมีเพียงชื่อรวม เอกสารต้นทางหาไม่พบ หรือประชาชนยังตรวจความเชื่อมโยงไม่ได้',
