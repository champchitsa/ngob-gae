...
export const signalLawMap: Record<SignalKey, string[]> = {
  ...
  missing_execution: ['พ.ร.บ. วิธีการงบประมาณ พ.ศ. 2561 ม.46', 'พ.ร.บ. ข้อมูลข่าวสารของราชการ พ.ศ. 2540 ม.9(3)'],
  ...
  vague_title: ['พ.ร.บ. ข้อมูลข่าวสารของราชการ พ.ศ. 2540 ม.9(3)', 'พ.ร.บ. จัดซื้อจัดจ้าง พ.ศ. 2560 ม.8'],
}
...
export const legalActionMap = [
  {
    ...
    trigger: 'พบราคาต่อหน่วยผิดช่วง คู่แข่งน้อย ชื่อรายการกว้าง หรือส่งมอบไม่สัมพันธ์กับยอดจ่าย',
  ...
  },
  {
    ...
    trigger: 'วงเงินสูง ผลลัพธ์ไม่ชัด ค่าใช้จ่ายซ้ำ หรือผลประโยชน์ต่อประชาชนยังตอบไม่ได้',
  ...
  },
  {
    ...
    url: 'https://www.ratchakitcha.soc.go.th/DATA/PDF/2561/A/092/1.PDF',
  },
  {
  ...
  },
  {
    ...
    title: 'กำหนดขอบเขตการพิจารณางบของฝ่ายนิติบัญญัติ',
    trigger: 'ใช้กำกับวิธีตั้งคำถามและติดตามหลักฐานในการพิจารณางบประมาณ',
