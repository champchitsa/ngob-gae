...
export const signalQuestions: Record<SignalKey, string[]> = {
  ...
  over_execution: [
    'ยอดรายงานรวม PO และเบิกจ่ายใช้ฐานเวลาและนิยามเดียวกับวงเงินหลังโอนหรือไม่',
...
export const signalLawMap: Record<SignalKey, string[]> = {
  new_after_act: ['พ.ร.บ. วิธีการงบประมาณ พ.ศ. 2561 ม.35 และ ม.36', 'พ.ร.บ. วินัยการเงินการคลังของรัฐ พ.ศ. 2561 ม.6'],
  transfer_up: ['พ.ร.บ. วิธีการงบประมาณ พ.ศ. 2561 ม.35 และ ม.36', 'พ.ร.บ. วิธีการงบประมาณ พ.ศ. 2561 ม.46'],
  transfer_down: ['พ.ร.บ. วิธีการงบประมาณ พ.ศ. 2561 ม.35 และ ม.36', 'พ.ร.บ. วิธีการงบประมาณ พ.ศ. 2561 ม.46'],
  missing_execution: ['พ.ร.บ. วิธีการงบประมาณ พ.ศ. 2561 ม.46', 'พ.ร.บ. ข้อมูลข่าวสารของราชการ พ.ศ. 2540 มาตรา 9 วรรคหนึ่ง (3)'],
  low_execution: ['พ.ร.บ. วิธีการงบประมาณ พ.ศ. 2561 ม.46', 'พ.ร.บ. วินัยการเงินการคลังของรัฐ พ.ศ. 2561 ม.6'],
  over_execution: ['พ.ร.บ. วิธีการงบประมาณ พ.ศ. 2561 ม.46', 'พ.ร.บ. วินัยการเงินการคลังของรัฐ พ.ศ. 2561 ม.6'],
  vague_title: ['พ.ร.บ. ข้อมูลข่าวสารของราชการ พ.ศ. 2540 มาตรา 9 วรรคหนึ่ง (3)', 'พ.ร.บ. จัดซื้อจัดจ้าง พ.ศ. 2560 ม.8'],
}

export const investigationPath = [
  { step: '01', title: 'ตั้งงบ', question: 'อนุมัติอะไร ให้ใคร และวัดผลอย่างไร', evidence: 'พ.ร.บ. งบประมาณ แผนอนุมัติ เป้าหมาย และราคาต่อหน่วย', law: 'วินัยการเงินการคลัง ม.6' },
  { step: '02', title: 'โอนเปลี่ยน', question: 'เงินย้ายจากไหน เพราะอะไร และเป้าหมายเปลี่ยนหรือไม่', evidence: 'คำสั่งโอน รายการต้นทางและปลายทาง เหตุผล และผู้อนุมัติ', law: 'วิธีการงบประมาณ ม.35 และ ม.36' },
  { step: '03', title: 'จัดซื้อ', question: 'TOR และการแข่งขันทำให้ได้ของคุ้มค่าหรือไม่', evidence: 'แผนจัดซื้อ TOR ราคากลาง ผู้เสนอราคา ผู้ชนะ และสัญญา', law: 'จัดซื้อจัดจ้าง ม.8' },
  { step: '04', title: 'ส่งมอบ', question: 'ของหรืองานตรงสัญญา ตรงเวลา และจ่ายตามผลงานหรือไม่', evidence: 'งวดงาน ใบตรวจรับ การแก้สัญญา ค่าปรับ PO และฎีกาเบิกจ่าย', law: 'วิธีการงบประมาณ ม.46' },
  { step: '05', title: 'เกิดผล', question: 'ผู้รับประโยชน์ได้อะไร และต้นทุนต่อผลลัพธ์เท่าไร', evidence: 'ผลผลิต ผลลัพธ์ ผู้รับประโยชน์ ค่าใช้จ่ายจริง และการประเมินหลังงาน', law: 'วินัยการเงินการคลัง ม.6' },
]

export const legalActionMap = [
  {
    code: 'จัดซื้อจัดจ้าง ม.8',
    title: 'คุ้มค่า โปร่งใส มีประสิทธิผล และตรวจสอบได้',
    trigger: 'พบราคาต่อหน่วยต่างจากกลุ่มเปรียบเทียบ จำนวนผู้เสนอราคาน้อย ชื่อรายการกว้าง หรือความก้าวหน้าการส่งมอบไม่สัมพันธ์กับยอดจ่าย',
    request: 'แผนจัดซื้อ TOR ราคากลาง รายชื่อผู้เสนอราคา ผลพิจารณา สัญญา การแก้สัญญา และใบตรวจรับ',
    url: 'https://www.ratchakitcha.soc.go.th/DATA/PDF/2560/A/024/13.PDF',
  },
  {
    code: 'วินัยการเงินการคลัง ม.6',
    title: 'ประสิทธิภาพ โปร่งใส ตรวจสอบได้ และมีวินัยทางการคลัง',
    trigger: 'วงเงินสูง ผลลัพธ์ยังไม่ชัด พบรายการที่มีลักษณะคล้ายกันซึ่งควรตรวจว่าเป็นค่าใช้จ่ายซ้ำหรือไม่ หรือยังตอบผลประโยชน์ต่อประชาชนไม่ได้',
    request: 'เหตุผลความจำเป็น ทางเลือก ต้นทุนต่อหน่วย ตัวชี้วัด ผู้รับประโยชน์ และผลประเมิน',
    url: 'https://www.ratchakitcha.soc.go.th/DATA/PDF/2561/A/027/1.PDF',
  },
  {
    code: 'วิธีการงบประมาณ ม.35 และ ม.36',
    title: 'ตรวจฐานอำนาจและเงื่อนไขของการโอนงบประมาณ',
    trigger: 'วงเงินเกิดหลัง พ.ร.บ. มีการโอนเพิ่ม ลด หรือย้ายระหว่างหน่วยรับงบประมาณ แผนงาน หรือรายการ',
    request: 'คำขอและคำอนุมัติโอน รายการต้นทางและปลายทาง ฐานอำนาจ แผนก่อนและหลังโอน และมติคณะรัฐมนตรีในกรณีที่กฎหมายกำหนด',
    url: 'https://ratchakitcha.soc.go.th/documents/2149304.pdf',
  },
  {
    code: 'วิธีการงบประมาณ ม.46',
    title: 'ติดตามและประเมินก่อน ระหว่าง และหลังใช้จ่าย',
    trigger: 'มีการโอนเพิ่ม ลดวงเงิน เบิกจ่ายช้า ไม่มีค่าระดับรายการ หรือยอดต้องกระทบยอดใหม่',
    request: 'คำสั่งโอน แผนปรับปรุง ทะเบียน PO ยอดเบิก งวดงาน เงินกันเหลื่อมปี และรายงานประเมินผล',
    url: 'https://ratchakitcha.soc.go.th/documents/2149304.pdf',
  },
  {
    code: 'ข้อมูลข่าวสาร ม.9 วรรคหนึ่ง (3)',
    title: 'แผนงาน โครงการ และงบประมาณประจำปีต้องเปิดให้ตรวจดูได้',
    trigger: 'มีเพียงชื่อรวม เอกสารต้นทางหาไม่พบ หรือประชาชนยังตรวจความเชื่อมโยงไม่ได้',
    request: 'แผนงาน โครงการ งบประจำปี รายการย่อย ผู้รับผิดชอบ และเอกสารที่เชื่อมรหัสงบกับสัญญา',
    url: 'https://www.ratchakitcha.soc.go.th/DATA/PDF/2540/A/046/1.PDF',
  },
  {
    code: 'รัฐธรรมนูญ ม.144',
    title: 'ข้อจำกัดการแปรญัตติและการมีส่วนในการใช้งบประมาณรายจ่าย',
    trigger: 'ใช้ตรวจการแปรญัตติที่เพิ่มรายการหรือจำนวน และการกระทำที่ทำให้สมาชิกหรือกรรมาธิการมีส่วนโดยตรงหรือโดยอ้อมในการใช้งบประมาณรายจ่าย',
    request: 'รายงานการพิจารณา คำแปรญัตติ มติ และหลักฐานที่แสดงบทบาทของผู้เกี่ยวข้อง',
...
export const bigData: {
  ...
  flags: [
    ...
    { id: 'over_execution', label: 'ยอดรายงานเกินหลังโอน 5%', definition: 'ยอดที่รายงานรวมเบิกจ่ายและ PO สูงกว่าวงเงินหลังโอนเกิน 5% ใช้เป็นจุดกระทบยอดนิยามและช่วงเวลา', count: 65, amount: 143974.7211 },
  ...
  themes: [
    ...
    { id: 'procurement', label: 'ปฏิรูปการจัดซื้อจัดจ้าง', rows: 1478, adjusted: 5582.7033, rate: 43.7 },
    ...
    { id: 'ai', label: 'พื้นฐาน AI', rows: 131, adjusted: 1396.0722, rate: 66.9 },
    { id: 'sso', label: 'สำนักงานประกันสังคม', rows: 87, adjusted: 129196.2214, rate: 100.1 },
  ],
  agencies: [
