...
- ถามตอบภาษาไทยด้วย Pathumma โดยค้นคืนแฟ้มวิเคราะห์ รายการ PBO ตัวเลขภาพรวม และตัวบทกฎหมายก่อนเรียบเรียงคำตอบ
...
คำสั่งข้างต้นเปิดเฉพาะส่วนติดต่อผู้ใช้ หากต้องการทดสอบผู้ช่วย Pathumma ให้คัดลอก `.env.example` เป็น `.env.local` ใส่ `PATHUMMA_API_KEY` แล้วใช้ Vercel Development Server:
